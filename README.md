# README - Trabalhos de Teoria e Modelo de Grafos
...
- [x] Retornar a ordem do grafo (número de vértices)
- [x] Retornar o tamanho do grafo (número de arestas)
- [x] Calcular a densidade do grafo
- [x] Retornar os vizinhos de um vértice
- [x] Determinar o grau de um vértice
- [x] Verificar se um vértice é uma articulação (ponto de corte)
- [x] Realizar busca em largura (BFS)
...
- [x] Determinar a árvore geradora mínima (MST)
